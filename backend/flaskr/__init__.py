...
def create_app(test_config=None):
    ...
    """
    CORS(app) #Initialization of the Flask-CORS
    ...
    @app.route('/questionsmark', methods=['POST'])
    def search_question():
        body = request.get_json()
    ...
    def retrieve_questions_per_category(category_id):
        ...
        try:        
            ...
            allCategories = Category.query.filter(Category.id == category_id).all()

            currentCategory = [category.type for category in allCategories]
            ...
            return jsonify({
                ...
                'current_category': currentCategory[0]
    ...
    def play_quiz():
        try:
            ...
            if quiz_category_id:
                all_questions = Question.query.filter(Question.category == quiz_category_id).all()
